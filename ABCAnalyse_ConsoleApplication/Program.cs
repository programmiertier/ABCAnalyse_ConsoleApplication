...
namespace ABCAnalyse_ConsoleApplication
{
    class Program
    {
        public static List<char> nennungen = new List<char>() { 'a', 'b', 'Z', 'L', 'q', 'C', 'M', 'b', 'Z', 'L', 'q', 'C', 'M', 'b', 'F', 'L', 'q', 'C', 'M', 'g', 'Z', 'L', 'q', 'g', 'M' };    // 'a', 'b', 'Z', 'L', 'q', 'C', 'M'
        ...
        static void Main(string[] args)
        {
            ...
            var query = (from anzahl in nennungen
                         group anzahl by anzahl into neueAnzahl
                         orderby (neueAnzahl.Count()) descending
